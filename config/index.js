...
var platforms = {
  instagram: {
    ...
    channels: {
      ...
      recapQuotidien: process.env.CHANNEL_RECAP_QUOTIDIEN_INSTAGRAM,
    },
  ...
  twitter: {
    ...
    channels: {
      ...
      recapQuotidien: process.env.CHANNEL_RECAP_QUOTIDIEN_TWITTER,
    },
  ...
  geelark: {
    ...
    channels: {
      ...
      recapQuotidien: process.env.CHANNEL_RECAP_QUOTIDIEN_GEELARK,
    },
  ...
  threads: {
    ...
    channels: {
      ...
      recapQuotidien: process.env.CHANNEL_RECAP_QUOTIDIEN_THREADS,
    },
